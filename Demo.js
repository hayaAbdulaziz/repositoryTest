...
//   render() {
//     const dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('./assets/Frame.png') : require('./assets/Frame.png');
//     return (
...
//     let icon = highlighted ? require('./assets/Frame.png') : require('./assets/Frame.png');
//     let evenRow = rowID % 2;
//     return (
